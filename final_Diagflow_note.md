...
<a href="#17">3. 设置环境变量</a>  
&emsp;<a href="#18">3.1 windows 用户的环境变量设置</a>  
&emsp;<a href="#19">3.2 linux, mac 用户的环境变量设置</a>  
<a href="#20">2.代理的操作：</a>  
...
&emsp;<a href="#27">2.2 代理的导入</a>  
&emsp;&emsp;<a href="#28">2.2.1 通过控制台导入</a>  
&emsp;&emsp;<a href="#29">2.2.2 通过客户端库导入</a>  
&emsp;<a href="#30">2.3 代理的导出</a>  
&emsp;&emsp;<a href="#31">2.3.1 使用控制台导出</a>  
&emsp;&emsp;&emsp;<a href="#32">2.3.1.1 步骤1</a>  
&emsp;&emsp;&emsp;<a href="#33">2.3.1.2 步骤2</a>  
&emsp;<a href="#34">2.3.2 使用客户端库导出</a>  
&emsp;<a href="#35">2.4 代理的删除</a>  
&emsp;&emsp;<a href="#36">2.4.1 通过控制台删除</a>  
&emsp;&emsp;<a href="#37">2.4.2 通过客户端库删除</a>  
<a href="#38">3. Dialogflow 控制台面板功能介绍</a>  
&emsp;<a href="#39">3.1 Build</a>  
&emsp;<a href="#40">3.2 Manage</a>  
&emsp;<a href="#41">3.3 Agent Test</a>  
&emsp;<a href="#42">3.4 Agent settings</a>  
<a href="#43">4. 流、页面、意图、实体、参数的概念</a>  
&emsp;<a href="#44">4.1 流</a>  
&emsp;&emsp;<a href="#45">4.1.1 流的特点</a>  
&emsp;&emsp;<a href="#46">4.1.2 流的初始页面</a>  
&emsp;&emsp;<a href="#47">4.1.3 流的增、删、导出、导入</a>  
&emsp;&emsp;&emsp;<a href="#48">4.1.3.1 增加流</a>  
&emsp;&emsp;&emsp;<a href="#49">4.1.3.2 删除流</a>  
&emsp;&emsp;&emsp;<a href="#50">4.1.3.3 导入流</a>  
&emsp;&emsp;&emsp;<a href="#51">4.1.3.4 导出流</a>  
&emsp;<a href="#52">4.2 页面 </a>  
&emsp;&emsp;<a href="#53">4.2.1 页面的特点</a>  
&emsp;&emsp;<a href="#54">4.2.2 普通页面的功能</a>  
&emsp;&emsp;&emsp;<a href="#55">4.2.2.1 Routes</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#56">4.2.2.1.1 Routes -- 添加意图</a>  
&emsp;&emsp;&emsp;&emsp;<a href="#57">4.2.2.1.2 Routes--添加判断条件</a>  
...
# <a name="17">3. 设置环境变量</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

[链接](https://cloud.google.com/iam/docs/service-accounts?hl=zh-cn&_ga=2.98308319.-139742340.1639388700)

拿到上一步下载的json密匙绝对路径

## <a name="18">3.1 windows 用户的环境变量设置</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="19">3.2 linux, mac 用户的环境变量设置</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="27">2.2 代理的导入</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
### <a name="28">2.2.1 通过控制台导入</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
步骤1：
...
### <a name="29">2.2.2 通过客户端库导入</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
步骤：</br>
- 先导出一个代理，那到该代理的二进制文件
...
```
## <a name="30">2.3 代理的导出</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
### <a name="31">2.3.1 使用控制台导出</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
#### <a name="32">2.3.1.1 步骤1</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
![image](https://user-images.githubusercontent.com/30898964/150994138-4e1a7d7a-3f05-46a4-91aa-bb2f5b4bf02c.png)
#### <a name="33">2.3.1.2 步骤2</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
![image](https://user-images.githubusercontent.com/30898964/150997846-3822be2d-1bc7-49db-b099-822f6eec67dd.png)

## <a name="34">2.3.2 使用客户端库导出</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
[文档链接](https://googleapis.dev/python/dialogflow-cx/latest/dialogflowcx_v3beta1/agents.html)
...
## <a name="35">2.4 代理的删除</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
### <a name="36">2.4.1 通过控制台删除</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
步骤1：
...
### <a name="37">2.4.2 通过客户端库删除</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
待更新......</r>
通过客户端库删除代理的方法可参照代理的创建代码段， 


# <a name="38">3. Dialogflow 控制台面板功能介绍</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

## <a name="39">3.1 Build</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

![image-20220125133721423](./imgs/image-20220125133721423.png)


## <a name="40">3.2 Manage</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="41">3.3 Agent Test</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="42">3.4 Agent settings</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
# <a name="43">4. 流、页面、意图、实体、参数的概念</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

## <a name="44">4.1 流</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

### <a name="45">4.1.1 流的特点</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="46">4.1.2 流的初始页面</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="47">4.1.3 流的增、删、导出、导入</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="48">4.1.3.1 增加流：</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

在dialogflow cx 控制台 ->点击build-> 点击 + 号->点击create flow->输入流名 ->回车保存</br>

![image-20220125161314942](./imgs/image-20220125161314942.png)

#### <a name="49">4.1.3.2 删除流：</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="50">4.1.3.3 导入流：</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="51">4.1.3.4 导出流：</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
## <a name="52">4.2 页面 </a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>

![image-20220125153012686](./imgs/image-20220125153012686.png)

[image-20220125170059852](./imgs/image-20220125170059852.png)

### <a name="53">4.2.1 页面的特点：</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
### <a name="54">4.2.2 普通页面的功能</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
#### <a name="55">4.2.2.1 Routes：</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="56">4.2.2.1.1 Routes -- 添加意图</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
...
##### <a name="57">4.2.2.1.2 Routes--添加判断条件</a><a style="float:right;text-decoration:none;" href="#index">[Top]</a>
